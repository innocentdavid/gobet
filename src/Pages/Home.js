    ...
    return (<>
        ...
        <div className="flex flex-col items-center mt-[80px] lg:mt-[284px] pb-20 px-3">
            <div className="sm-items-center flex flex-col lg:flex-row gap-5">
                    ...
                    <div style={{ borderTop: 'none' }} className="bg-[rgba(0,0,0,.5)] rounded-b-[10px] py-[20px] px-[20px] border-[5px] border-[#EA9E1A]">
                        <div className="flex gap-5">
                            <div className="flex-1 flex flex-col items-center justify-center border-[3px] pt-2 pb-4 border-[#EA9E1A] rounded-[10px]">
                                <p className="text-[14px] md:text-[17px] text-white font-akkuratPro">Total Pool</p>
                                <h2 className="text-[17px] md:text-[28.8px] text-[#F08717] font-akkuratPro">0.00 BNB</h2>
                            </div>
                            <div className="flex-1 flex flex-col items-center justify-center border-[3px] pt-2 pb-4 border-[#EA9E1A] rounded-[10px]">
                                <p className="text-[14px] md:text-[17px] text-white font-akkuratPro">Ticket Remaining</p>
                                <h2 className="text-[17px] md:text-[28.8px] text-[#F08717] font-akkuratPro">1000000</h2>
                            </div>
                        </div>

                        <p className="text-[14px] md:text-lg text-center text-white py-3 font-akkuratPro">Ticket Sales have now CLOSED for this draw</p>
                ...
                <div className="bg-[rgba(0,0,0,.5)] rounded-[10px] pr-2 font-akkuratPro">
                    <div style={{ background: 'url(/images/Group2.png)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }} className="min-h-[340px] bg-center bg-no-repeat px-[35px] pt-[60px]">
                    ...
                    <div className="relative mt-10 lg:mt-6 mb-5 lg:mb-3 px-[20px]">
                ...
                border-4 border-[#de8b2f] rounded-[8px] px-[35px] w-full py-[10px] flex justify-center items-center gap-5 text-[#3D1105] text-[17px] md:text-[19.45px] font-bold">Buy 1 tickets for 0.0080 BNB</button>
                    </div>
                </div>
            </div>
